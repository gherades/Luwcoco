...
export const termsSections: LegalSection[] = [
  ...
  {
    heading: "Sección 1 - Acceso y cuenta",
    paragraphs: [
  ...
  {
    heading: "Sección 2 - Nuestros productos",
    paragraphs: [
  ...
  {
    heading: "Sección 3 - Pedidos",
    paragraphs: [
      "Al realizar un pedido en Luwcoco, el usuario está efectuando una oferta de compra de un producto digital descargable. El pedido se considerará aceptado una vez confirmado el pago y facilitado el acceso a la descarga del archivo digital. La entrega se realiza de forma automática mediante descarga electrónica. Debido a la naturaleza digital del producto y a que la descarga es inmediata tras la compra, no es posible cancelar el pedido una vez completado el pago. De conformidad con la normativa española vigente, al realizar la compra el usuario consiente expresamente la ejecución inmediata del contrato y reconoce que pierde su derecho de desistimiento. La compra de los patrones digitales es exclusivamente para uso personal, quedando prohibida su reventa, distribución o explotación comercial sin autorización expresa.",
    ],
  },
  {
    heading: "Sección 4 - Precios y facturación",
    paragraphs: [
  ...
  {
    heading: "Sección 5 - Envío y entrega",
    paragraphs: [
  ...
  {
    heading: "Sección 7 - Herramientas opcionales",
    paragraphs: [
  ...
  {
    heading: "Sección 8 - Enlaces de terceros",
    paragraphs: [
