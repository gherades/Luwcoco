  ...
  return (
    ...
    >
      <Link href={`/patrones/${product.slug}`} className="group block">
        <div
          className={`relative flex aspect-[4/5] items-center justify-center overflow-hidden rounded-2xl border border-line bg-gradient-to-br ${bgByCategory[product.category]}`}
        >
