...
export default function SobreMiPage() {
  return (
    <>
      ...
      <div
        id="historia"
        className="mx-auto max-w-3xl scroll-mt-24 px-5 py-20 sm:px-8 lg:px-24"
      >
        <FadeIn>
        ...
        <div className="mt-14 space-y-14">
          ...
          >
            <p>
              ...
              cuando tenía 16 años, se quedó guardada durante años… esperando el
              momento adecuado.
            </p>
          </SewingSection>
          ...
          >
            <p>
              ...
              necesidad de explorar algo creativo. Saqué la máquina de coser sin
              imaginar que terminaría cambiando mi vida por completo.
            </p>
          </SewingSection>
          ...
          >
            <p>
              ...
              comprar telas o incluso cómo es mi vida como arquitecta y creadora
              de contenido de costura.
            </p>
          </SewingSection>

          <FadeIn
            delay={0.1}
            className="relative rounded-3xl bg-thread-dark px-6 py-10 text-center text-paper sm:px-12"
          >
            <SewingDoodle
              rotate={14}
              delay={0.2}
          ...
          >
            <p>
              LUWCOCO nace de una idea clara: poder crear lo que yo quiera — un
              espacio donde comparto todo lo que he aprendido y sigo
              aprendiendo. Me encanta enseñar a coser, pero aún más me encanta
              mostrarte de lo que eres capaz cuando entiendes el proceso.
            </p>
          </SewingSection>
